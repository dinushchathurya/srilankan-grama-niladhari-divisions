    ...
    public static $Division = array(
        ...
        'Kandy' => array(
            ...
            'Minipe' => array(
                ...
                '08 Ela-(08 ඇල)',
                'Welgala-(වැල්ගාල)',
                'Mahayaya South-(මහයාය දකුණ)',
                'Thorapitiya-(තෝරපිටිය)',
                'Keenapelessa-(කිණපැලැස්ස)',
                'Mahagalahinna-(මහගලහින්න)',
                'Hasalaka-(හසළක)',
                'Pallewatta-(පල්ලේවත්ත)',
                'Hasalaka Nagaraya-(හසළක නගරය)',
                'Mahaassedduma-(මහඇස්සැද්දුම)',
                'Rathnella-(රත්නැල්ල)',
                'Gurulupotha-(ගුරැළුපොත)',
                'Waragolla-(වරාගොල්ල)',
                'Weragama-(වේරගම)',
                'Bulathwelkandura-(බුළත්වැල්කදුර)',
            ...
            'Kundasale' => array(
                ...
                'Ihala Gonagama-(ඉහළ ගෝනාගම)',
                'Delgaslanda-(දෙල්ගස්ලන්ද)',
                'Lunuketiyamaditta-(ලුනුකැටියාමඩිත්ත	)',
                'Naranpanawa East-(නාරම්පනාව නැගෙනහිර)',
                'Kuruambemuduna-(කුරුඅඹේමුදුන)',
                'Maluwegama-(මාළුවේගම)',
                'Wepathana-(වැපතන)',
                'Gonawala North-(ගෝනවල උතුර)',
                'Deliwalathenna-(දැලිවලතැන්න)',
                'Heepitiya-(හීපිටිය)',
                'Udagama South-(උඩගම දකුණ)',
                'Maharathenna East-(මහරතැන්න නැගෙනහිර)',
                'Manikhinna-(මැණික්හින්න)',
                'Hurikaduwa North-(හුරිකඩුව උතුර)',
                'Hurikaduwa West-(හුරිකඩුව බටහිර)',
                'Bogaskumbura-(බෝගස්කුඹුර)',
                'Pilawala North-(පිලවල උතුර)',
                'Amunugama North-(අමුණුගම උතුර)',
                'Amunugama South-(අමුණුගම දකුණ)',
                'Udagunnepana South-(උඩගුන්නැපාන දකුණ)',
                'Udagunnepana North-(උඩගුන්නෑපාන උතුර)',
                'Gabadagama South-(ගබඩාගම දකුණ)',
                'Gabadagama North-(ගබඩාගම උතුර)',
                'Pallegunnepana South-(පල්ලේගුන්නෑපාන දකුණ)',
                'Pallegunnepana North-(පල්ලේගුන්නෑපාන උතුර)',
                'Sirimalwatte West-(සිරිමල්වත්ත බටහිර)',
                'Sirimalwatta East-(සිරිමල්වත්ත නැගෙනහිර)',
                'Sirimalwatte Pallegama-(සිරිමල්වත්ත පල්ලෙගම)',
                'Lewellagama-(ලේවැල්ලගම)',
                'Degaldoruwa-(දෙගල්දොරුව)',
                'Deekirimadawala-(දීකිරිමඩවල)',
                'Hapuwala-(හපුවල)',
                'Galapitambe-(ගලපිටඅඹේ)',
                'Hathamuna-(හතමුණ)',
                'Dodamgolla-(දොඩම්ගොල්ල)',
                'Hurikaduwa South-(හුරිකඩුව දකුණ)',
                'Hurikaduwa East-(හුරිකඩුව නැගෙනහිර)',
                'Hurikaduwa Madige-(හුරිකඩුව මඩිහේ)',
                'Galamuna-(ගල්අමුණ)',
                'Malpana-(මල්පාන)',
                'Ahaspokuna North-(අහස්පොකුණ උතුර)',
                'Gonawala South-(ගෝනවල දකුණ)',
                'Kumbukkandura South-(කුඹුක්කදුර දකුණ)',
                'Kumbukkandura North-(කුඹුක්කදුර උතුර)',
                'Rajawella North-(රජවැල්ල උතුර)',
                'Ahaspokuna South-(අහස්පොකුණ දකුණ)',
                'Ihalawela-(ඉහලවෙල)',
                'Kengalla-(කෙන්ගල්ල)',
            ...
            'Hatharaliyadda' => array(
                'Paragoda-(පරගොඩ)',
                'Aludeniya North-(අළුදෙණිය උතුර)',
                'Aludeniya South-(අලුදෙණිය දකුණ)',
                'Alakolamaditta-(අලකොලමඩිත්ත)',
                'Amboruwa-(අඹෝරුව)',
                'Galdola-(ගල්දොල)',
                'Polwatta Ihalagama-(පොල්වත්ත ඉහළගම)',
                'Ilpemada-(ඉල්පේමඩ)',
                'Polwatta-(පොල්වත්ත)',
                'Dunkumbura-(දුංකුඹුර)',
                'Nikathenna-(නිකතැන්න)',
                'Narangaspitiya-(නාරංගස්පිටිය)',
                'Godathale-(ගොඩතලේ)',
                'Kalotuwawa-(කලෝටුවාව)',
                'Dedunupitiya Pahalagama-(දේදුනුපිටිය පහලගම)',
                'Damunupola-(දමුණු‍පොල)',
                'Pallepola-(පල්ලෙපොල)',
                'Welagama-(වෙලගම)',
                'Weligodapola-(වැලිගොඩපොළ)',
                'Hatharaliyadda-(හතරලියැද්ද)',
                'Kanakkarapola North-(කනක්කරපොල උතුර)',
                'Mawathagama-(මාවතගම)',
                'Imbulethenna-(ඉඹුලේතැන්න)',
                'Welivita Ihalagama North-(වැලිවිට ඉහලගම උතුර)',
                'Welivita Ihalagama-(වැලිවිට ඉහලගම)',
                'Sivurupitiya-(සිවුරුපිටිය)',
                'Eramuduliyadda-(එරමුදුලියද්ද)',
                'Muruddeniya-(මුරුද්දෙනිය)',
                'Walpalagolla North-(වල්පලාගොල්ල උතුර)',
                'Walpalagolla East-(වල්පලාගොල්ල නැගෙනහිර)',
                'Walpalagolla South-(වල්පලාගොල්ල දකුණ)',
                'Welivita Pahalagama-(වැලිවිට පහලගම)',
                'Handabowa-(හඳබෝව)',
                'Meegasthenna-(මීගස්තැන්න)',
                'Kanakkarapola South-(කනක්කරපොල දකුණ)',
                'Avulbodale-(අවුල්බෝදලේ)',
                'Lechchimimenila-(ලෙච්චමි වැනිලා)',
                'Yaggala-(යග්ගල)',
                'Rangamuwa-(රංගමුව)',
                'Dedunupitiya Ihala-(දේදුනුපිටිය ඉහළ)',
                'Ambawa-(අම්බාව)',
                'Dehideniya Madige-(දෙහිදෙණිය මඩිගේ)',
                'Pelena Pahalagama-(පැලැන පහලගම)',
                'Pelena-(පැලැන)',
                'Kandemeeya-(කන්දේමීය)',
                'Alagalla Pahalagama-(අලගල්ල පහලගම)',
                'Alagalla Ihala-(අලගල්ල ඉහලගම)',
                'Mudagammana-(මුඩගම්මන)',
                'Pattapola Ihalagama-(පට්ටපොල ඉහලගම)',
                'Pattapola Pahala-(පට්ටපොල පහළ)',
                'Welivita Pahalagama South-(වැලිවිට පහළගම දකුණ)',
                'Andiyathenna-(ආඩියාතැන්න)',
                'Kolugala-(කොළුගල)',
            ...
            'Udunuwara'=> array(
                ...
                'Alapalawala West-(අලපලාවල බටහිර)',
                'Walgama-(වල්ගම)',
                'Rabbegamuwa North-(රබ්බේගමුව උතුර)',
                'Rabbegamuwa South-(රබ්බේගමුව දකුණ)',
            ...
            'Pathahewaheta' => array(
                ...
                'Uduwela Pallegama South-(උඩුවෙල පල්ලෙගම දකුණ)',
                'Uduwela Udagama West-(උඩුවෙල උඩගම බටහිර)',
                'Uduwela Udagama East-(උඩුවෙල උඩගම නැගෙනහිර)',
                'Ratemulla-(රටේමුල්ල)',
                'Pooliyadda-(පුලියද්ද)',
                'Ethulgama West-(ඇතුල්ගම බටහිර)',
                'Ethulgama South-(ඇතුගල්ගම දකුණ)',
                'Haputhale Egodagama-(හපුතලේ එගොඩගම)',
                'Haputhale Udagama-(හපුතලේ උඩගම)',
                'Moragolla-(මොරගොල්ල)',
                'Nugaliyadda Ihala-(නුගලියද්ද ඉහළ)',
                'Nugaliyadda Pahala-(නුගලියද්ද පහළ)',
                'Bootawatta South-(බූටාවත්ත දකුණ)',
                'Godamunna West-(ගොඩමුන්න බටහිර)',
                'Narangasthenna-(නාරංගස්තැන්න)',
                'Godalawela-(ගොඩලවෙල)',
                'Bolepa-(බෝලෑප)',
                'Pathamailapitiya South-(පාතමයිලපිටිය දකුණ)',
                'Pathamailapitiya North-(පාතමයිලපිටිය උතුර)',
                'Udamailapitiya North-(උඩමයිලපිටිය උතුර)',
                'Damunugolla-(දමුණුගොල්ල)',
                'Marassana-(මාරස්සන)',
                'Medadeniya-(මඩදෙනිය)',
                'Welegama-(වෙලේගම)',
                'Godamunna East-(ගොඩමුන්න නැගෙනහිර)',
                'Letiyagolla-(ලෑටියගොල්ල)',
                'Sriyagama-(ශ්‍රියාගම)',
                'Medagama Udagama-(මැදගම උඩගම)',
                'Medagama Pallegama-(මැදගම පල්ලේගම)',
                'Kandewela-(කන්දෙවෙල)',
                'Elikewela-(ඇලිකේවෙල)',
                'Meeruppa-(මීරුප්ප)',
                'Kethigannawela-(කැතිගන්නාවෙල)',
                'Udamailapitiya South-(උඩමයිලපිටිය දකුණ)',
                'Galagoda-(ගලගොඩ)',
                'Hewavissa East-(හේවාවිස්ස නැගෙනහිර)',
                'Hewavissa West-(හේවාවිස්ස බටහිර)',
                'Bawlana-(බව්ලාන)',
                'Oluwawatta-(ඕලුවාවත්ත)',
                'Kiriwanagoda-(කිරිවනාගොඩ)',
                'Ududeniya Madihe-(උඩුදෙනිය මඩිහේ)',
                'Unuvinna East-(උනුවින්න නැගෙනහිර)',
                'Unuvinna West-(උනුවින්න බටහිර)',
                'Ududeniya-(උඩුදෙනිය)',
                'Bopitiya-(බෝපිටිය)',
                'Pothgoda-(පොත්ගොඩ)',
            ...
            'Udapalatha' => array(
                'Egoda Kalugamuwa-(එගොඩ කළුගමුව)',
                'Udovita-(උඩෝවිට)',
                'Kirinda-(කිරින්ද)',
                'Galgediyawa-(ගල්ගෙඩියාව)',
                'Ranawala-(රණවල)',
                'Bowala-(බෝවල)',
                'Rathmalkaduwa-(රත්මල්කඩුව)',
                'Hapugaspitiya-(හපුගස්පිටිය)',
                'Unambuwa-(උනම්බුව)',
                'Ilangawatta-(ඉලංගවත්ත)',
                'Kahatapitiya-(කහටපිටිය)',
                'Bothalapitiya-(බෝතලාපිටිය)',
                'Gampola East-(ගම්පොළ නැගෙනහිර)',
                'Mount Temple-(මවුන්ටෙම්පල්)',
                'Keerapane-(කීරප‍‍නේ)',
                'Sinhapitiya North-(සිංහපිටිය උතුර)',
                'Sinhapitiya South-(සිංහපිටිය දකුණ)',
                'Gampola West-(ගම්පොළ බටහිර)',
                'Polkumbura-(පොල්කුඹුර)',
                'Illawathura-(ඉල්ලවතුර)',
                'Angammana East-(අංගම්මන නැගෙනහිර)',
                'Angammana West-(අංගම්මන බටහිර)',
                'Eragoda-(ඇරෑගොඩ)',
                'Kurukude-(කුරුකුදේ)',
                'Kudamake-(කුඩමාකේ)',
                'Godagama-(ගොඩගම)',
                'Jayamalapuraya-(ජයමාලාපුර)',
                'Amunupuraya-(අමුණුපුරය)',
                'Wattehena-(වත්තෙහේන)',
                'Millagaspitiya-(මිල්ලගස්පිටිය)',
                'Udagama-(උඩගම)',
                'Hunukotugama-(හුණුකොටුගම)',
                'Dunukeulla-(දුනුකේඋල්ල)',
                'Wanahapuwa-(වනහපුව)',
                'Ihalagama-(ඉහළගම)',
                'Paradeka-(පාරදෙක)',
                'Amuhena-(අමුහේන)',
                'Delpitiya-(දැල්පිටිය)',
                'Nawa Devita-(නව දේවිට)',
                'Galatha-(ගලත)',
                'Pallegama-(පල්ලෙගම)',
                'Pussellawa-(පුස්සැල්ලාව)',
                'Wahugapitiya-(වහුගපිටිය)',
                'Pussellawagama-(පුස්සැල්ලාවගම)',
                'Doragala-(දොරගල)',
                'Kekulanda-(කැකුලන්ද)',
                'Weliganga-(වැලිගඟ)',
            ...
            'Pasbage Korale' => array(
                ...
                'Dandubendiruppa-(දඬුබැඳිරුප්ප)',
                'Penithuduwa-(පැණිතුඩුව)',
                'Phala Rambukpitiya-(පහළ රඹුක්පිටිය)',
                'Uda Rambukpitiya-(උඩ රඹුක්පිටිය)',
                'Balanthota north-(බලංතොට උතුර)',
                'Weligampala-(වැලිගම්පල)',
                'Karahandungala-(කරහඳුන්ගල)',
                'Nawalapitiya South-(නාවලපිටිය දකුණ)',
                'Nawalapitiya North-(නාවලපිටිය උතුර)',
                'Nawalapitiya West-(නාවලපිටිය බටහිර)',
                'Nawalapitiya East-(නාවලපිටිය නැගෙනහිර)',
                'Imbulpitiya-(ඉඹුල්පිටිය)',
                'Greenwood-(ග්‍රීන්වුඩ්)',
                'Bawwagama-(බව්වාගම)',
                'Kendopitiya-(කැන්දෝපිටිය)',
                'Aluthgama-(අලුත්ගම)',
                'Balanthota South-(බලංතොට දකුණ)',
                'Dekinda-(දෙකිඳ)',
                'Mapakanda North-(මාපාකන්ද උතුර)',
                'Inguruoya North-(ඉඟුරුඔය උතුර)',
                'Kadiyanlena-(කඩියන්ලෙන)',
                'Westhole-(වෙස්ට්හෝල්)',
                'Inguruoya South-(ඉඟුරුඔය දකුණ)',
                'Mapakanda South-(මාපාකන්ද දකුණ)',
                'Wewegama-(වැවේගම)',
                'Hydry-(හයිඩ්‍රි)'
            )
        )
